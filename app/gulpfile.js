...
gulp.task('watch:images', function () {
	gulp.watch([config.imagesFolder + '/**/*.{jpeg,jpg,png}', 'plugins/**/*.{jpeg,jpg,png}'], ['build:sprite']);
});
...
gulp.task('inject:plugins', function () {
	return gulp.src('*.htm')
	// css
   .pipe(inject(gulp.src('plugins/node_modules/bootstrap/dist/css/bootstrap.min.css', {read: false}), {starttag: '<!-- inject:bootstrap.css -->', relative: true}))
   .pipe(inject(gulp.src('plugins/jquery-ui-1.11.2/jquery-ui.min.css', {read: false}), {starttag: '<!-- inject:jquery-ui.css -->', relative: true}))
   .pipe(inject(gulp.src(['plugins/**/*.css', '!plugins/node_modules/bootstrap/dist/css/bootstrap.min.css', '!plugins/jquery-ui-1.11.2/jquery-ui.min.css'], {read: false}), {relative: true}))
   .pipe(inject(gulp.src(config.cssFolder + '/main.css', {read: false}), {starttag: '<!-- inject:main.css -->', relative: true}))
   // js
   .pipe(inject(gulp.src(['plugins/node_modules/jquery/dist/jquery.min.js'], {read: false}), {starttag: '<!-- inject:jquery.js -->', relative: true}))
   .pipe(inject(gulp.src(['plugins/jquery-ui-1.11.2/jquery-ui.min.js'], {read: false}), {starttag: '<!-- inject:jquery-ui.js -->', relative: true}))
   .pipe(inject(gulp.src(['plugins/node_modules/bootstrap/dist/js/bootstrap.min.js'], {read: false}), {starttag: '<!-- inject:bootstrap.js -->', relative: true}))
   .pipe(inject(gulp.src(['plugins/**/*.js', '!plugins/node_modules/jquery/dist/jquery.min.js', '!plugins/jquery-ui-1.11.2/jquery-ui.min.js', '!plugins/node_modules/bootstrap/dist/js/bootstrap.min.js'], {read: false}), {relative: true}))
